...
public class TokenDeleteHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TokenDeleteHandlerTest.class);
    ...
    @Test
    @Ignore
    public void testTokenDeleteHandlerTest() throws ClientException, ApiException {
        ...
        try {
            ClientRequest request = new ClientRequest().setPath("/v1/token/2123765411126543").setMethod(Methods.DELETE);
