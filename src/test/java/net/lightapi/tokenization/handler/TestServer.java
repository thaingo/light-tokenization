...
public class TestServer extends ExternalResource {
    ...
    private TestServer() {
        ...
        try (Connection connection = ds.getConnection()) {
            String schemaResourceName = "/scripts/create_tokenization.sql";
            ...
            schemaResourceName = "/scripts/create_vault.sql";
            in = TestServer.class.getResourceAsStream(schemaResourceName);
